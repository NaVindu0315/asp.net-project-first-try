<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="grren_captain1.WebForm1" %>
...
<asp:Button ID="incident3" runat="server" Text="Incident 3" style="position:absolute; top:322px; left:227px; border-radius: 10px;" OnClick="incident3_Click" />
            ...
            <asp:Image ID="MyImage" runat="server" ImageUrl="~/images/clmb.png" Height="519px" Width="597px" />
<!--incident 2 button-->
...
<asp:Button ID="incident1" runat="server" Text="Incident 1" style="position:absolute; top:279px; left:489px; border-radius: 10px; height: 26px;" OnClick="incident1_Click" />
            ...
            <asp:GridView ID="complainview" runat="server" Height="262px" OnSelectedIndexChanged="complainview_SelectedIndexChanged" Width="340px" >
